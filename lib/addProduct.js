...
var AmazonDataSet_js_1 = require("./AmazonDataSet.js");
var db_js_1 = require("./db.js");
function insertProducts() {
    return __awaiter(this, void 0, void 0, function () {
        var count, insertedProducts, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, Product_js_1.default.insertMany(AmazonDataSet_js_1.productsFromAmazon)];
                case 3:
                    insertedProducts = _a.sent();
                    console.log("\u2705 Inserted ".concat(insertedProducts.length, " products successfully"));
                    return [3 /*break*/, 6];
                case 4:
                    error_1 = _a.sent();
